...
# Knowledge becomes intelligence with the right question

❌ *"How do I fix the Favorites tab not updating?"*

✅ *"What could cause a TanStack Query list to not refresh after a mutation? List the causes, then check which one applies here."*

First ask **what plays a role** and **what the consequences are**. Then ask for
solutions, and let it weigh them.

Thinking mode does the same thing for you: it works out what matters before it
answers. Your question can do that too.
