...
The product gets you to a 6. How you worked with the agent, and how well it is finished, takes you higher.
...
Full git history, no squashing. Link in Teams before the deadline.
...
|---|---|---|
| Product | 60% | Works, complete, code quality |
| Directing | 15% | Small tasks, context, your own choices, instructions that grow |
| Checking | 15% | You read, tested and corrected the agent's work |
...
**Directing.** One task at a time. Give context: spec, files, instructions. You decide, the agent executes. What you learn about the agent goes into `copilot-instructions.md`.
