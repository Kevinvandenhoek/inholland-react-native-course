...
A **native stack**: the new screen slides in, swipe back works, the OS animates it. Day 2.
...
A subset of CSS as JavaScript objects. Flexbox everywhere. Day 2.
...
`day-1/exercises/02-ask-copilot.md`. Ask your agent tool to explain the project you just created.
