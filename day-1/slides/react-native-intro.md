...
- iOS developer at Hypersolid (Alkmaar)
- Some experience with React and React Native, but iOS first
...
<table style="width:100%; table-layout:fixed; border:none;">
  ...
  <tr style="border:none;">
    <td style="border:none; text-align:center; font-size:1rem; color:#888;">iOS Dev</td>
...
## In 10 minutes: exercise 1, Setup. Bring your phone.

`day-1/exercises/01-setup.md`. The next deck walks through the same steps.
